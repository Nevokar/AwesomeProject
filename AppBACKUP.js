...
import { StyleSheet, View, Button, StatusBar, ScrollView, ImageBackground } from "react-native";
...
export default function App() {
  ...
  return (
    ...
    <NativeBaseProvider config={config}>
      <ImageBackground
      source={{uri: "https://images.unsplash.com/photo-1688999558024-0bbeac1c0102?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80"}}
      resizeMode="cover"
      style={styles.image}
      >
